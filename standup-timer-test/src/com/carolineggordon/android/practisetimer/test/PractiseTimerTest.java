...
import com.carolineggordon.android.practisetimer.mock.PractiseTimerMock;
...
public class PractiseTimerTest extends ActivityUnitTestCase<PractiseTimerMock> {

    private static final int DEFAULT_NUM_PARTICIPANTS = 2;
    private static final int DEFAULT_MEETING_LENGTH = 60 * 5;
    private PractiseTimerMock a = null;

    public PractiseTimerTest() {
        super(PractiseTimerMock.class);
    }
